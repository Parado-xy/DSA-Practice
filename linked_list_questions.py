...
# Implement a function is_palindrome(head) that takes a head node of a singly linked list (which is the first node in the list) and returns True if the linked list is a palindrome and False otherwise. 
